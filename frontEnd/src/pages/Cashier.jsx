...
const Cashier = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // With the new RLS policies, the database will automatically return:
      // - Products owned by the user (if admin)
      // - Products owned by the user's owner (if cashier)
      // No need to manually fetch admin's products separately!
  ...
  const fetchCategories = async () => {
    ...
    try {
      // With the new RLS policies, the database will automatically return:
      // - Categories owned by the user (if admin)
      // - Categories owned by the user's owner (if cashier)
      // No need to manually fetch admin's categories separately!
